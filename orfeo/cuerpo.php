...
if($orden_cambio==1){
  ...
  if(!$carpeta) $carpeta=0;
    ...
    $encabezado     = session_name()."=".session_id()."&depeBuscada=$depeBuscada&filtroSelect=$filtroSelect&tpAnulacion=$tpAnulacion&carpeta=$carpeta&tipo_carp=$tipo_carp&adodb_next_page=1&busqRadicados=$busqRadicados&nomcarpeta=$nomcarpeta&agendado=$agendado&orderTipo=$orderTipo&chkCarpeta=$chkCarpeta";
    ?>
