...
?>
  ...
  <?php
	...
	$nomb_varde = "sgd_srd_descrip";
   	include "$ruta_raiz/include/query/trd/queryCodiDetalle.php";
        //Modificación por Metro Cali S.A. se cambio id por sgd_srd_codigo
 ...
 ?>
  ...
  $fecha_hoy = date("Y-m-d");
	$sqlFechaHoy="'".$fecha_hoy."'";
        //modificación por Metro Cali S.A. se cambio id por sgd_sbrd_codigo
...
<br>
  ...
  $isql = "select t.sgd_tpr_codigo as CODIGO, t.sgd_tpr_descrip as DETALLE
			 ...
			 where m.depe_codi = '$coddepe'
 			       and m.sgd_srd_codigo = '$codserie'". // Modificación echa por Metro Cali S.A. se cambio sgd_srd_id por sgd_srd_codigo
			       "and m.sgd_sbrd_codigo = '$tsub'". //Modificación echa por Metro Cali S.A. se cambio sgd_sbrd_id por sgd_sbrd_codigo
...
<br>
	...
	$isqlF = "select a.sgd_tpr_codigo as CODIGO
			...
			, a.sgd_tpr_codigo AS \"CHK_SGD_TPR_CODIGO\"
	         ...
	         from sgd_mrd_matrird m, sgd_tpr_tpdcumento t
			 where m.depe_codi = '$coddepe'
 			       and m.sgd_srd_codigo = '$codserie'". //Modificación por Metro Cali S.A. se cambio sgd_srd_id por sgd_srd_codigo
			       "and m.sgd_sbrd_codigo = '$tsub' ". //Modificación echa por Metro Cali S.A. se cambio sgd_sbrd_id por sgd_sbrd_codigo
				   "and m.sgd_tpr_codigo = t.sgd_tpr_codigo)
	...
	$pager->toRefLinks = $linkPagina;
	$pager->toRefVars = $encabezado;
	$pager->Render($rows_per_page=5500,$linkPagina,$checkbox=chkEnviar);
