...
{	case 'mssql':
	{	switch ($tmp_arr_id)
		{	case 0:
				{	$isql = 'select
							cast(b.RADI_NUME_RADI as varchar(14)) as "IMG_Numero Radicado"
							...
							,cast(RADI_NUME_RADI as varchar(14)) "CHK_CHKANULAR"
							from
								radicado b
		 					where
			...
			case 1:
				{	$radi_nume_radi = "cast(i.RADI_NUME_RADI as varchar(14))";
			...
			case 2:
				{	
					...
					$isql = 'select
						 	...
						 	where
						 		i.radi_nume_radi = b.radi_nume_radi and
						 		CAST( i.info_codi AS VARCHAR(10) ) = u.usua_doc and
						  		i.RADI_NUME_RADI is not null
						  		AND (i.USUA_CODI = '.$_SESSION['codusuario'].') AND (i.DEPE_CODI = '.$_SESSION['dependencia'].')
								'.$whereFiltro.$tmp_where.'
								'.$whereCarpeta.'
