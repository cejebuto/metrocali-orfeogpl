...
<tr bordercolor="#FFFFFF">
	<td align="center" class="listado2" width="48%"><a href="tbasicas/adm_soportes.php?<?=$sendSession?>" class="vinculos" target='mainFrame'>13. SOPORTES</a></td>
	<td align="center" class="listado2" width="48%"><a href="tbasicas/adm_plantillas.php?<?=$sendSession?>" class="vinculos" target='mainFrame'>14. PLANTILLAS</a></td>
</tr>
<tr bordercolor="#FFFFFF">
